...
const I18N = {
  zh: {
    ...
    notice:'公開研究與娛樂實驗，不是投注建議。Live ≠ Final：只用官方/高可信終場來源結算；來源、風險和社群訊號都收在細節裡，不硬演。',
  ...
  en: {
    ...
    notice:'Public research and entertainment only — not betting advice. Live ≠ Final: settlements wait for official/high-confidence final sources; sources, risks and social signals stay in the details.',
