...
const I18N = {
  zh: {
    ...
    notice:'公開研究與娛樂實驗，不是投注建議。Live ≠ Final：半場、加時、補時都只當現場脈絡；終場先找官方/高可信來源，再結算；社群只收可驗證公開來源，看不到的留言不硬演聲量。',
  ...
  en: {
    ...
    notice:'Public research and entertainment only — not betting advice. Live ≠ Final: halftime, extra time and stoppage-time snippets are context; settlements wait for official/high-confidence final sources, and social chatter stays labeled.',
